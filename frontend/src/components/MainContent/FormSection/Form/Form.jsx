        ...
        <form styleName="values-form" onSubmit={(e) => handleSubmit(e)}>
          ...
          <span className="values-form__label-text">
            R
                ...
                <div styleName="values-form__control">
                    <TextField value={props.rCurrent} changeValue={props.changeR} maxLength="7" placeholder="Число от -5 до 3" />
                </div>
            </div>
          ...
          <span className="values-form__label-text">
            X
                ...
                <div styleName="values-form__control">
                    <TextField value={props.xCurrent} changeValue={props.changeX} maxLength="7" placeholder="Число от -5 до 3" />
                </div>
            </div>
