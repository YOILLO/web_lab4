...
const GraphSvg = (props) => {
    return(
        <svg width="220" height="220" className="svg-graph" xmlns="http://www.w3.org/2000/svg">
            ...
            <polygon className="svg-figure triangle-figure" points="76,110 110,110 110,76"
            ...
            <path className="svg-figure circle-figure" d="M 143 110 A 35 35 0 0 0 111 76 L 110 110 Z"
